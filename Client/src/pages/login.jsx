      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center">
            <h2 className="text-white text-3xl font-bold">Let’s Make Your Space Pristine Again!</h2>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-6" id="login-form">
            ...
            <div className="relative">
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" style={{ fill: passwordVisible ? '#007bff' : 'currentColor' }}>
