...
import { X, Image as ImageIcon, Clock, Banknote, FileText, List, Plus } from 'lucide-react';
import { toast } from 'sonner';
import { updateService } from '../../../api/services';

const EditServiceModal = ({ visible, service, onClose, onSuccess }) => {
  ...
  useEffect(() => {
    if (service) {
      setFormData({
        ...
        includedServices: service.includedServices || [{ title: '', description: '' }],
        image: null,
      });
